...
#debug
DFLAGS=-nofloat -d -property -version=NOGCSAFE -I..\druntime\import 
...
test.exe : test.obj phobosnogc.lib
...
cov : $(SRCS) phobosnogc.lib
	$(DMD) -cov -unittest -ofcov.exe unittest.d $(SRCS) phobosnogc.lib
	cov
