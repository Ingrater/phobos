...
$(LIB_SHARED) : $(SRC_TO_COMPILE) \
	...
	$(DMD) -shared=exportall -defaultlib="" -of$(DLL) $(DFLAGS) $(SRC_TO_COMPILE) \
		$(ZLIB) -L/IMPLIB:imp_$(LIB_SHARED) \
		$(DRUNTIME_SHARED_OBJ) $(DRUNTIME_SHARED_C_LIB) $(DRUNTIME_SHARED_DLLINIT)
